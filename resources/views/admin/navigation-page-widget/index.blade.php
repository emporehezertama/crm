                  ...
                  <tbody>
                   @foreach($data as $key => $item)
                    <tr>
                      ...
                      <td width="100">
                        <form method="POST" action="{{ route('admin.navigation-page-widget.destroy', ['id' => $item->id]) }}">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}
                          ...
                          <a href="{{ route('admin.navigation-page-widget.edit', ['id' => $item->id]) }}" title="Edit Data"><i class="la la-edit"></i></a>
                        </form>
                      </td>
                    </tr>
                   @endforeach
