...
<head>
  ...
  <title>Login - {{ get_setting('title') }}</title>
                ...
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                      ...
                      @if(!empty($logo))
                      <img src="{{ asset('upload/setting/'. $logo) }}" alt="{{ get_setting('title') }}" style="width: 40%">  
                      @else
                      <h3>Logo Here</h3>
                      @endif
                    </div>
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal form-simple" novalidate method="POST" action="{{ route('login') }}">
                      {{ csrf_field() }}
                      @if($errors->has('email'))
                        <label style="color: red;">Email atau Password anda salah, silahkan dicoba kembali</label> 
                      @endif
                      ...
                      <div class="form-group row">
                        <div class="col-md-6 col-12 text-center text-md-left">
                          <fieldset>
                            <input type="checkbox" id="remember-me" value="1" name="remember_me" class="chk-remember">
