      ...
      <div class="col-12">
        <div class="card">
          <div class="card-content collapse show">
            <div class="card-body">
              <form class="form form-horizontal" method="POST" action="{{ route('admin.navigation-page-widget.store') }}" enctype="multipart/form-data" >
                  ...
                  <div role="tabpanel" class="tab-pane active" id="ind" aria-expanded="true" aria-labelledby="">
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <textarea class="form-control" id="ckeditor" name="description" placeholder="Type here .." style="height: 100px;"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                          <input type="number" class="form-control" name="order" placeholder="Type here .." />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane" id="eng" aria-labelledby="base-eng">
                    <div class="form-body">
                      <div class="form-group">
                        <div class="col-md-9">
                          <label class="label-control">Navigation</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5">
                          <input type="text" class="form-control" name="title_eng" placeholder="Type here .." />
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                          <textarea class="form-control" id="ckeditor_eng" name="description_eng" placeholder="Type here .." style="height: 100px;"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                          <input type="number" class="form-control" name="order_eng" placeholder="Type here .." />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-actions">
                  <a href="{{ route('admin.navigation-page-widget.index') }}" class="btn btn-warning btn-sm"><i class="ft ft-arrow-left"></i> Cancel</a>
